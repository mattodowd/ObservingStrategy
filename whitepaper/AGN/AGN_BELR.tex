...
%Comment from Matt O: It seems the most powerful measurable will be the 
%dependence of reverberation time lag on emission line ionization energy. 
%It's going to be hard to get any line shape info, but in combination with 
%photoioniation models, an ionization energy-size relationship is potentially 
%very constraining on both geometry and on the state of the broad line flow; 
%e.g. local optimized clouds vs. stratified BELR. Of course the exact same 
%measurements can be made by looking at differential microlensing between 
%broad emission lines for an independent determination.
